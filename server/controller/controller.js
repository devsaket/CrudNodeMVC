var Userdbmvc = require('../model/model')
...
exports.update = (req,res) => {
    ...
    Userdbmvc.findByIdAndUpdate(id, req.body, { useFindAndModify: false})
    .then(data => {
        if(!data){
...
exports.delete = (req,res) => {
    ...
    Userdbmvc.findByIdAndDelete(id)
    .then(data=>{
        if(!data){
